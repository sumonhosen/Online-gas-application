...
<html class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface no-generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <body class="menu_horizontal push-mode show_menu tiny menu-fixed header-fixed compact slickgrid-large-font body-small-font  apple-screen">
        ...
        <div class="printBtn"><!-- Begin: rc_footer -->
            <a href="invoice.php?app_id=<?php echo  $app_id; ?>" target="_blank"><button class="btn btn-info" type="submit" class="sign">Download</button></a>
        </div>
            ...
            <div style="width: 100%" align="center">
                <table style="text-align: center">
                    <tbody><tr>
                        ...
                        <td width="70%" style="font-size: 18px; font-weight: bolder">
Sundarban Gas Company Limited (A Company of Petrobangla)
                        </td>
                        <td width="15%" rowspan="3"><img id="passportSizePhoto" height="150px" width="150px" src="10300000104.jpg"></td>
                        <!--<img id="passportSizePhoto"  height="150px" width="150px" src="/static/images/no_image_available.jpg"/>-->
                    </tr>
                    <tr>
                        <td style="font-size: 15px;">218,M. A. Bari Sarak , Abir Tower, Sonadanga , Khulna-9100
</td>
                    </tr>
                    <tr>
            ...
            <div style="position: fixed;left: 0;bottom: 0;width: 100%;color: #347AB7;text-align: right;">
                <p>Powered by: Divine IT Limited</p>
            </div>
        </div>
        <div>
            <h2>Attachments</h2>
            <div id="attachments" style="width: 100%;" align="center">
                ...
                <a target="_blank" href="download.php?file=/<?php echo $noc_of_department[12];?>">Download </a>
                <br>
                Others : &nbsp; &nbsp; &nbsp;<a target="_blank" href="download.php?file=/<?php echo $others[13];?>">Download </a>
                <br>
            </div>
        </div>
